...
:::{#argument .argument}
## @argument-AS: **The Argument from Suffering**
...
- (DB3) So, you should not believe that all the suffering in the actual world is necessary for some unknown greater good that an omnibeing has in mind
...
- (FS3) So, if the Psychological Descendant Account is true, then ChadRW is the same person as AlexRW
...
- (FP3) There is no morally relevant difference between what Fred does and you buying and eating factory-farmed meat
...
- (TR3) There is no morally relevant difference between diverting the trolley and killing Nick
